...
class SlimUNETR(nn.Module):
    def __init__(self, in_chans=4, out_chans=3, kernel_sizes=[2, 2, 2, 2], depths=[1, 1, 1, 1], dims=[48, 96, 192, 384], heads=[1, 2, 4, 4], hidden_size=768, num_slices_list = [16, 8, 4, 2],
                out_indices=[0, 1, 2, 3]):
