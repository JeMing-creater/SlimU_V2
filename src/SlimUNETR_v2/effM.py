...
class SS2D(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # in proj =======================================
        self.zx_channel = d_expand
        self.in_proj = nn.Linear(d_model, self.zx_channel*2, bias=bias, **factory_kwargs)
    ...
    def forward(self, x: torch.Tensor, **kwargs):
        ...
        if self.d_conv > 1:
            ...
            D = W
            x= x.permute(0, 2, 1).reshape(B, H, W, D).contiguous()
...
class VSSBlock(nn.Module):
    ...
    def _forward(self, input: torch.Tensor):
        ...
        x_flat = input.reshape(B, C, n_tokens).transpose(-1, -2)
        x = self.norm(x_flat)
        x_ssm = self.op(x)
...
if __name__ == '__main__':
    ...
    #         # ===================
    #         d_state=16,
    #         dt_rank=("auto" if "auto" == "auto" else int("auto")),
    #         ssm_ratio=2.0,
    #         attn_drop_rate=0.0,
    #         # ===================
    #         drop_rate=0.0,
