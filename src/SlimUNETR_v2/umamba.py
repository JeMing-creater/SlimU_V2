...
def get_umamba_enc_3d_from_plans(
    ...
    conv_or_blocks_per_stage = {
        "n_conv_per_stage": configuration_manager.network_arch_init_kwargs[
            "n_conv_per_stage"
        ],
        "n_conv_per_stage_decoder": configuration_manager.network_arch_init_kwargs[
...
if __name__ == "__main__":
    network_class = UMambaEnc
    model = model = network_class(
        input_channels=4,
        n_stages=3,
        features_per_stage=[min(32 * 2**i, 320) for i in range(3)],
        conv_op=conv_op,
        kernel_sizes=configuration_manager.network_arch_init_kwargs["kernel_sizes"],
        strides=configuration_manager.pool_op_kernel_sizes,
        num_classes=label_manager.num_segmentation_heads,
